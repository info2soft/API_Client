...
public class Request {
    ...
    public static String generateUrl(TreeMap<String, Object> params,
        ...
        if (params.get("service").toString().equals("MultipartUploadVodFile")) {
...
//			params.put("Timestamp", System.currentTimeMillis() / 1000);
        ...
        try {
            params.put("signature", Sign.sign(plainText, secretKey));
            System.out.println(params.get("signature"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String sendRequest(String url,
        ...
        for (String key : requestParams.keySet()) {
            ...
            try {
                ...
                result = "{\"code\":-2300,\"location\":\"com.i2.Common.Request:129\",\"message\":\"api sdk throw exception! "
                        + e.toString() + "\"}";
            }
        }
        ...
        try {
            ...
            result = "{\"code\":-2700,\"location\":\"com.i2.Common.Request:225\",\"message\":\"api sdk throw exception! "
                    + e.toString() + "\"}";
        } finally {
            // 使用finally块来关闭输入流
            try {
                ...
                result = "{\"code\":-2800,\"location\":\"com.i2.Common.Request:234\",\"message\":\"api sdk throw exception! "
                        + e2.toString() + "\"}";
            }
        }
        rawResponse = result;
    ...
    public static String sendMultipartUploadVodFileRequest(String url,
        ...
        for (String key : requestParams.keySet()) {
            ...
            try {
                ...
                result = "{\"code\":-2400,\"location\":\"com.i2.Common.Request:263\",\"message\":\"api sdk throw exception! "
                        + e.toString() + "\"}";
            }
        }
        ...
        try {
            ...
            if (offset >= file_length) {
                return "{\"code\":-3001,\"location\":\"com.i2.Common.Request:303\",\"message\":\"api sdk throw exception! offset larger than the size of file\"}";
            }
            ...
            try {
                ...
                result = "{\"code\":-3002,\"location\":\"com.i2.Common.Request:331\",\"message\":\"api sdk throw exception! protocol doesn't support input or the character Encoding is not supported."
                        + "details: " + e.toString() + "\"}";
                if (in != null) {
                    in.close();
                }
            ...
            result = "{\"code\":-3000,\"location\":\"com.i2.Common.Request:345\",\"message\":\"api sdk throw exception! "
                    + e.toString() + "\"}";
        } finally {
            // 使用finally块来关闭输入流
            try {
                ...
                result = "{\"code\":-3003,\"location\":\"com.i2.Common.Request:354\",\"message\":\"api sdk throw exception! "
                        + e2.toString() + "\"}";
            }
        }
        rawResponse = result;
